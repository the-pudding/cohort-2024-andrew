...
<g class="axis-container">
    <g class="x-axis" transform="translate({margin.left},{margin.top})" class:hide-axis={step < 2}>
        <line x1={xScale(xTicks[0])-20} x2={chartWidth} y1={yScale(yTicks[yTicks.length-1])} y2={yScale(yTicks[yTicks.length-1])} stroke="black"></line>
        {#each xTicks as tick, index}
            <line x1={xScale(tick)} x2={xScale(tick)} y1={yScale(yTicks[yTicks.length-1])} y2={yScale(yTicks[yTicks.length-1])-10} stroke="black"></line>
    ...
    <g class="y-axis" transform="translate({margin.left},{margin.top})">
        <line x1={xScale(xTicks[0])} x2={xScale(xTicks[0])} y1={margin.top} y2={yScale(yTicks[yTicks.length-1])+20} stroke="black"></line>
